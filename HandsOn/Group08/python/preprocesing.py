...
COLLEGE_RANKING = BASE_PATH + "US-News-Rankings-Liberal-Arts-Colleges-Through-2023-updated.csv"
UNIVERSITY_ARTS_RANKING = BASE_PATH + "US-News-Rankings-Universities-Through-2023-updated.csv"
...
df_ranks[columns_to_title_case] = df_ranks[columns_to_title_case].apply(lambda x: x.str.title())
...
df_ranking_college = df_ranking_college.melt(id_vars=['IPEDSID'], var_name='Year', value_name='Ranking')
...
df_ranking_university = df_ranking_university.melt(id_vars=['IPEDSID'], var_name='Year', value_name='Ranking')
