...
Original file is located at
    https://colab.research.google.com/drive/1XW4I6vRCWSELc8bG1MZ8DrVsdb5UUuht
...
g.add((ns.JaneSmith, vcard.EMAIL, Literal("jane.smith@example.com", datatype=XSD.string)))
# Visualize the results
for s, p, o in g:
  print(s,p,o)
