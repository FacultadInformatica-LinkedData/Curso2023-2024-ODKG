...
Original file is located at
    https://colab.research.google.com/drive/1xpxKtyTWYIiyH9LiKSQ_dc_X0FxlsLcW
...
jane = g.add((ns.JaneSmith, vcard.Email, Literal("jane.smith@gmail.com", datatype=XSD.string)))
