...
Original file is located at
    https://colab.research.google.com/drive/1cJe0tuF-0lm6sTTfiFbtsBYSuYU4lrnu
...
g.add((ns.JaneSmith, VCARD.Email, Literal('JaneSmith@upm.com', datatype=XSD.string)))
g.remove((ns.JaneSmith, VCARD.Email, Literal('Smith', datatype=XSD.string)))
