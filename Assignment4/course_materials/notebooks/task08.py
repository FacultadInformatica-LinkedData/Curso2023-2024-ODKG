...
Original file is located at
    https://colab.research.google.com/drive/1HTvihnpdulvSZsfDb7o_AJVY-xsONdar
...
for person in persons:
  for property in properties:
    ...
    if not g1.query(query):
      print(f"{person} {property} is missing")
      # Try to find it in g2
      g2_property = g2.query(query)
      if g2_property:
        for r in g2_property:
          print(f"Found missing property in g2 with value {r[2]}")
          g1.add((r[0], r[1], r[2]))
          print(f"Added property to g1")
          print()
